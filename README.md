...
Website of the Go club from Banja Luka. It contains information about the club and
the game of Go, the club's history, a tournament calendar, tournament announcements
with online player registration, news, and a list of the club's friends. The site
is multilingual (Serbian-Latin, English, German).

**Technologies**

- ASP.NET Core MVC (.NET 8)
- Entity Framework Core + Pomelo MySQL provider
- Localization (`sr-Latn`, `en`, `de`) via `.resx` resources and session
- DocumentFormat.OpenXml — Word (`.docx`) documents are converted to HTML
- Bootstrap 5 + custom styles (`wwwroot/css/site.css`)
